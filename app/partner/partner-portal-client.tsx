    ...
    return (
      <main style={styles.loginPage}>
        <section style={styles.loginCard}>
          ...
          <div><span style={styles.kicker}><ShieldCheck size={16} /> ACCESSO PARTNER</span><h1 style={styles.loginTitle}>Entra nel tuo spazio operativo</h1><p style={styles.muted}>Accedi per gestire offerte, pratiche, documenti e commissioni della tua società.</p></div>
    ...
    <main style={styles.page}>
      ...
      <div style={styles.content}>
        ...
        {section === "overview" ? <section style={styles.twoCol}>
          ...
          <article style={styles.panel}><span style={styles.kicker}>SICUREZZA</span><h2 style={styles.panelTitle}>Perimetro della società</h2><p style={styles.muted}>Offerte, clienti, documenti e commissioni restano filtrati server-side sulla tua organizzazione.</p></article>
        </section> : null}
