...
const s: Record<string, React.CSSProperties> = {
  ...
  summary: { display: "grid", gridTemplateColumns: "repeat(3,minmax(0,1fr))", gap: 12, margin: "22px 0" }, summaryItem: { display: "grid", gap: 6, minWidth: 0 }, summaryLabel: { color: "#66768a", fontSize: 12, fontWeight: 800 }, summaryValue: { color: "#102033", fontSize: 15, lineHeight: 1.35, overflowWrap: "anywhere" }, detailSection: { marginTop: 20, paddingTop: 18, borderTop: "1px solid #e4eaf0" }, docs: { display: "grid", gridTemplateColumns: "repeat(2,minmax(0,1fr))", gap: 8, marginTop: 10 }, textarea: { width: "100%", minHeight: 92, marginTop: 10, boxSizing: "border-box", border: "1px solid #cbd8e6", borderRadius: 12, padding: 12, fontSize: 15, resize: "vertical" },
