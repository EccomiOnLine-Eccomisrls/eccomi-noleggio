  ...
  return <main style={s.page}>
    ...
    <div style={s.content}>
      ...
      <section style={s.panel}>
        ...
        <div style={s.upload}><div style={s.file}>⬆️ <span style={s.fileText}><strong>Seleziona quotazione PDF</strong><small>PDF · massimo 15 MB</small></span></div><button disabled style={s.primary}>Invia a verifica ECCOMI</button></div>
      </section>
      ...
      <section style={s.panel}>
        ...
        <div style={s.grid}>{offers.map((item) => <article key={item.offer} style={s.card}>
          ...
          <div style={s.meta}><div style={s.metaItem}><small>SCADENZA</small><strong>{item.date}</strong></div><div style={s.metaItem}><small>GESTIONE</small><strong>{item.status === "IN VERIFICA ECCOMI" ? "ECCOMI sta verificando" : "Partner"}</strong></div></div>
